...
| `MH-RTI-NOTIFICATION-2013-FEE-FORM` | Possible legacy fee/form change | [Maharashtra RTI circular index and official notification download](https://rti.maharashtra.gov.in/circular) | Official scanned notification dated 23 Apr 2013 is captured and hashed, but its operative Marathi text has not yet been independently transcribed and reviewed | `unverified` | Obtain accessible Gazette text or two-person transcription; do not use for product behavior yet |
| `MH-RTI-FORMAT` | Application and appeal forms/fees | [Maharashtra State Information Commission RTI format](https://sic.maharashtra.gov.in/site/Downloads/Important_Letters/RTI%20Format.pdf) | Annexure A uses a ₹10 court-fee stamp; Annexure B first appeal uses a ₹20 court-fee stamp and states a 30-day appeal period | `verified` (technical) | Reconcile all permitted offline payment modes and obtain legal/RTI review |
| `MH-PORTAL-FAQ` | Online first-appeal fee | [Maharashtra RTI Online FAQ](https://rtionline.maharashtra.gov.in/FAQ-RTI-Online.pdf) | Online first appeal fee is ₹20 | `verified` (technical) | Hash current FAQ and verify live payment flow |
