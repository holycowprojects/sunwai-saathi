...
| `CENTRAL-INDIA-POST-STRUCTURE` | Department of Posts routing structure | [India Post structure of all circles](https://www.indiapost.gov.in/rti/structureofcircle) | Current page exposes separate postal-circle structures, confirming decentralized geographic routing | `verified` (technical) | Locate a current complete designation-based CPIO/FAA directory; do not rely on stale indexed pages |
| `CENTRAL-DOT-CPIO-FAA-2025` | DoT subject directory | [DoT CPIO/FAA matrix as on 5 Dec 2025](https://dot.gov.in/sites/default/files/Details%20of%20CPIOs%20and%20FAAs%20in%20DoT_0.pdf?download=1) | Maps departmental subjects to CPIO and FAA designations and rooms | `verified` (technical) | Outside six-month freshness window; obtain current confirmation before selection |
| `CENTRAL-DOT-RTI-ADMINISTRATION` | DoT RTI routing boundary | [DoT administration report, Chapter 7](https://www.dot.gov.in/static/uploads/2025/07/ede9c96ddd5253a339f3c6f4cabbcc7d.pdf) | Central RTI Cell receives and forwards DoT applications/appeals; attached bodies are separate authorities | `verified` (technical) | Encode safe attached-authority exclusion; legal/RTI review |
| `CENTRAL-DOT-CONTACT` | DoT service address | [Current official DoT contact page](https://www.eservices.dot.gov.in/saral/contact-us) | Confirms Sanchar Bhawan, 20 Ashoka Road, New Delhi 110001 | `verified` (technical) | Address evidence only; pair with a current directory |
| `CENTRAL-UIDAI-RTI-HUB` | UIDAI directory hub | [UIDAI RTI hub](https://uidai.gov.in/en/contact-support/rti.html) | Links HO/RO CPIO/FAA lists as on 18 May 2026 with appointment archives | `verified` (directory metadata only) | Independently review current directory files |
| `CENTRAL-UIDAI-STALE-SECTION8` | UIDAI legal-text conflict | [Same UIDAI RTI hub](https://uidai.gov.in/en/contact-support/rti.html) | Displays superseded pre-13-November-2025 Section 8(1)(j) wording | `disputed`; quarantined | Current national statutory baseline always controls |
| `CENTRAL-UIDAI-STRUCTURE` | UIDAI regional routing | [UIDAI organizational structure](https://uidai.gov.in/en/about-uidai/unique-identification-authority-of-india/organizational-structure.html) | Maps eight Regional Offices to covered States/UTs | `verified` (technical) | Encode privacy-safe regional selection; verify service addresses |
| `CENTRAL-UIDAI-ANNUAL-2024-25` | UIDAI RTI activity and intake | [UIDAI Annual Report 2024–25](https://uidai.gov.in/images/E_UIDAI_Annual_Report_24-25.pdf) | Nodal RTI Cell processes online/offline matters; 3,979 applications and 461 appeals handled | `verified` (technical) | Statistics support selection only; legal/RTI review |

| `CENTRAL-EPFO-RTI-HUB` | EPFO RTI route discovery | [EPFO RTI hub](https://www.epfindia.gov.in/site_en/RTI.php?id=sm12_index) | Recently indexed official hub links RTI Online and EPFO RTI resources, but direct retrieval returned 404 | `disputed`; quarantined | Locate a stable current RTI landing page; never infer directory currency from an index |
| `CENTRAL-EPFO-DIRECTORY` | EPFO office-directory discovery | [EPFO directory](https://www.epfindia.gov.in/site_en/Contact_us.php) | Recently indexed Head Office/zonal/field-office addresses; direct retrieval returned 404 | `disputed`; quarantined | Verify stable addresses together with current CPIO/FAA designations |
| `CENTRAL-EPFO-OFFICE-LOCATOR` | EPFO geographic office discovery | [EPFO bilingual office locator](https://www.epfindia.gov.in/site_en/Location_an_office.php/FAQ.php) | Nationwide State/UT, district and office selection; page warns displayed data is under field-office verification | `verified` (discovery only) | Require user confirmation; cannot activate filing-ready routing |
| `CENTRAL-EPFO-REACH` | EPFO population/structure evidence | [EPFO organization overview](https://www.epfindia.gov.in/site_en/index.php/site_docs/site_docs/site_docs/pdfs/PDFs/Downloads_PDFs/OrgChart_Eng.pdf) | Indexed official material reports 29.88 crore member accounts and 147 offices | `verified` (candidate scoring only) | Historical reach figures; not RTI routing evidence |

| `CENTRAL-RAILWAYS-ANNUAL-2023-24` | Railway authority structure and reach | [Indian Railways Annual Report and Accounts 2023-24](https://indianrailways.gov.in/railwayboard/uploads/directorate/stat_econ/2025/Indian%20Railways%20Annual%20Report%20%20Accounts%202023-24%20-English.pdf) | Separates Railway Board, 17 zones, production/other units and corporations or autonomous bodies | `verified` (technical) | Boundary evidence only; legal/RTI review |
| `CENTRAL-RAILWAYS-RTI-ARCHITECTURE` | Railway RTI boundary evidence | [SECR zonal RTI architecture](https://secr.indianrailways.gov.in/uploads/files/1738839104318-rti_05022025.pdf) | Depicts separate divisional, zonal and Railway Board RTI/appeal chains | `verified` (technical) | Not a Board directory; define nested routing model |
| `CENTRAL-RAILWAYS-NFR-DIRECTORY-2025` | Current zonal directory example | [Northeast Frontier Railway Nodal RTI Cell directory](https://nfr.indianrailways.gov.in/uploads/files/1750227194865-FC.pdf) | Maps CPIO/FAA offices by department within one zonal headquarters | `verified` (boundary evidence only) | Never reuse across zones; incumbent/contact data excluded |

| `CENTRAL-DFS-RTI-HUB` | DFS current directory metadata and filing route | [DFS RTI hub](https://www.financialservices.gov.in/rti) | Lists 16 Jun 2026 CPIO/AA appointment entry and online application/appeal route | `verified` (metadata only) | Independently inspect directory contents and portal label |
| `CENTRAL-DFS-ANNUAL-2025-26` | DFS RTI activity and online route | [DFS Annual Report 2025-26](https://financialservices.gov.in/sites/default/files/2026-05/DFS-ANNUAL-REPORT-ENGLISH-2025-26.pdf) | Reports 6,387 applications and 167 appeals through 30 Nov 2025; confirms Central RTI Online | `verified` (technical, address excluded) | Statistics and route only; legal/RTI review |
| `CENTRAL-DFS-ADDRESS-CONFLICT` | DFS postal-address conflict | [Same DFS annual report](https://financialservices.gov.in/sites/default/files/2026-05/DFS-ANNUAL-REPORT-ENGLISH-2025-26.pdf) | Annual report PIN conflicts with February directory and current grievance-page PIN | `disputed`; quarantined | Resolve from current appointment document; block postal output |
| `CENTRAL-DFS-GRIEVANCE-BOUNDARY` | DFS versus institution record boundary | [DFS grievance overview](https://www.financialservices.gov.in/grievances-overview) | Separately lists banks, institutions, insurers and regulators and their own mechanisms | `verified` (technical) | Encode record-holder guardrails; legal/RTI review |
