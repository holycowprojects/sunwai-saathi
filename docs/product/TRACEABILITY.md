...
| Standard 30-day clock only | Current RTI Act Section 7(1), pending final capture | Receipt-event deadline module | Boundary and confidence-label tests |
| First appeal | Current RTI Act Sections 19(1)/(6), pending final capture | Six reviewed appeal modules | Branch-complete zero-critical suite |
